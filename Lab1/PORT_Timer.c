...
void ( *PRT_T0_pTimerAppFunc)( void ) = 0;

/**********************/
/* Functions / (ISRs) */
/**********************/

UINT8 PRT_T0_InitializeTimer( UINT8 bVal )
{
...
UINT8 PRT_T0_Set_Callback( void ( *pTimerFunc)( void ) )
{
	...
	PRT_T0_pTimerAppFunc = pTimerFunc;
	return 0;
}
...
void ISR_TIMER0_COMPA (void)
{
	...
	if ( PRT_T0_pTimerAppFunc )
	{
		/* Call application space function */
		PRT_T0_pTimerAppFunc();
	}
}
